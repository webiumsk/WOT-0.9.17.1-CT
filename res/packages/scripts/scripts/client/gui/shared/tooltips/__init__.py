# 2017.02.03 21:52:49 Støední Evropa (bìžný èas)
...
def getUnlockPrice(compactDescr, parentCD = None):
    ...
    if item_type_id == vehicles._VEHICLE:
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:50 Støední Evropa (bìžný èas)

...
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\dossiers2\custom\fort_layout.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:17 Støední Evropa (bìžný èas)

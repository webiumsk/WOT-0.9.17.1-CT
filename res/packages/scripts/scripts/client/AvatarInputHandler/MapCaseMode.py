...
def turnOffMapCase(equipmentID):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\MapCaseMode.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:06 Støední Evropa (bìžný èas)

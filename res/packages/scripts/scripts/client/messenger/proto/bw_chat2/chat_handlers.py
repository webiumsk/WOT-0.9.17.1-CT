# 2017.02.03 21:53:41 Støední Evropa (bìžný èas)
...
class AdminChatCommandHandler(provider.ResponseDictHandler):
    ...
    def _onResponseSuccess(self, ids, args):
        ...
        if cmd:
            g_messengerEvents.channels.onCommandReceived(cmd)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\bw_chat2\chat_handlers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:42 Støední Evropa (bìžný èas)

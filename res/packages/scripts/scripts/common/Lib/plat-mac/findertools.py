...
if __name__ == '__main__':
    ...
    _test2()
    _test3()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\findertools.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 22:00:22 Støední Evropa (bìžný èas)

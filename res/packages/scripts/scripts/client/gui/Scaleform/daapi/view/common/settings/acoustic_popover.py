...
class AcousticPopover(AcousticPopoverMeta):
    ...
    def as_disposeS(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\common\settings\acoustic_popover.pyc 

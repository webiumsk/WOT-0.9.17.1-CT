# 2017.02.03 21:52:45 Støední Evropa (bìžný èas)
...
class TokensAwardTooltipData(SeasonAwardTooltipData):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        return blocks
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\potapovquests.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:46 Støední Evropa (bìžný èas)

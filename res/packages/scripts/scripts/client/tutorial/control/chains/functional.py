# 2017.02.03 21:54:13 Støední Evropa (bìžný èas)
...
class FunctionalShowAwardWindow(FunctionalEffect):
    ...
    def triggerEffect(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\control\chains\functional.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:14 Støední Evropa (bìžný èas)

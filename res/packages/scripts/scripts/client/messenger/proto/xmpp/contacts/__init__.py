# 2017.02.03 21:53:52 Støední Evropa (bìžný èas)
...
class ContactsManager(ClientEventsHandler):
    ...
    def __ms_onUserPreferencesUpdated(self):
        self.__seq.release()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\contacts\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:53 Støední Evropa (bìžný èas)

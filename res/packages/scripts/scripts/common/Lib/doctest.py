# 2017.02.03 21:56:03 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    sys.exit(_test())
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\doctest.pyc 

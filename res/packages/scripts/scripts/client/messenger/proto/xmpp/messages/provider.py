# 2017.02.03 21:53:57 Støední Evropa (bìžný èas)
...
class ChatProvider(ClientHolder):
    ...
    def _getChannelsIterator(self, msgType):
        ...
        for channel in channels:
            yield channel
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\messages\provider.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:58 Støední Evropa (bìžný èas)

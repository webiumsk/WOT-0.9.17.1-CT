# 2017.02.03 21:48:16 Støední Evropa (bìžný èas)
...
class ServerStats(IServerStatsController):
    ...
    def __clearStatsCallback(self):
        if self.__statsCallbackID is not None:
            ...
            self.__statsCallbackID = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\game_control\ServerStats.pyc 

...
class MessengerBar(MessengerBarMeta):
    ...
    def __manageWindow(self, eventType):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\messengerBar\messenger_bar.pyc 

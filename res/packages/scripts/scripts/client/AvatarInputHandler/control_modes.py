# 2017.02.03 21:47:02 Støední Evropa (bìžný èas)
...
def _swap(data, index1, index2):
    ...
    data[index2] = tmp
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\control_modes.pyc 

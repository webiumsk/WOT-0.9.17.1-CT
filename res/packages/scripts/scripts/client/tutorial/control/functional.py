# 2017.02.03 21:54:09 Støední Evropa (bìžný èas)
...
class GoToSceneEffect(FunctionalEffect):
    ...
    def triggerEffect(self):
        ...
        if sceneID is None:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\control\functional.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:10 Støední Evropa (bìžný èas)

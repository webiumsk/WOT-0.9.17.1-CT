...
class FortTransportationViewHelper(FortViewHelper):
    ...
    def __getTransportingBuildTooltipData(self, building):
        ...
        if state is not None:
            ...
            return
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\fort_utils\FortTransportationViewHelper.pyc 

# 2017.02.03 21:57:22 Støední Evropa (bìžný èas)
...
class bsdTableDB:
    ...
    def Drop(self, table):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\bsddb\dbtables.pyc 

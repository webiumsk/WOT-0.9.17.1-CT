# 2017.02.03 21:53:37 Støední Evropa (bìžný èas)
...
def validateUserRoomPwdPair(password, retype):
    ...
    if error is not None:
        ...
        return (password, None)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\bw\bw_chat_string_utils.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:38 Støední Evropa (bìžný èas)

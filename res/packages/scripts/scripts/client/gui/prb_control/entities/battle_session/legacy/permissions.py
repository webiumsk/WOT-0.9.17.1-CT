...
class BattleSessionPermissions(LegacyPermissions):
    ...
    def _canAddPlayers(self):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\battle_session\legacy\permissions.pyc 

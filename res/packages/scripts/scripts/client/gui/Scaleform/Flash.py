# 2017.02.03 21:48:55 Støední Evropa (bìžný èas)
...
class _ExternalInterfaceObj():
    ...
    def __call__(self, command, args):
        ...
        if obj:
            ...
            LOG_CODEPOINT_WARNING('weak object has been already destroyed.')
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\Flash.pyc 

...
class FriendsGroupsConverter(IContactsConverter):
    ...
    def makeVO(self, pattern = None):
        ...
        return vos
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\data\contacts_vo_converter.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:30 Støední Evropa (bìžný èas)

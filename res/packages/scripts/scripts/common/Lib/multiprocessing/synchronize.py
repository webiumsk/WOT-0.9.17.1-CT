# 2017.02.03 22:00:04 Støední Evropa (bìžný èas)
...
class Event(object):
    ...
    def wait(self, timeout = None):
        ...
        try:
            ...
            self._cond.release()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\multiprocessing\synchronize.pyc 

...
class MarkersManager(ExternalFlashComponent, VehicleMarkersManagerMeta, plugins.IMarkersManager):
    ...
    def __destroyPlugins(self):
        if self.__plugins is not None:
            ...
            self.__plugins.fini()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\markers2d\manager.pyc 

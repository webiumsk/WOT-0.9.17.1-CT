...
def createPlayer(view, acousticType):
    ...
    if acousticType in _PRESETS:
        ...
        return None
        return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\common\settings\acoustic_presets.pyc 

# 2017.02.03 21:55:14 Støední Evropa (bìžný èas)
...
def computeFortResource(id, idToFinalStats, vehPlayersInfo, division, resourceBonus, fortClanDBIDs):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\dossiers2\custom\battle_results_processors.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:15 Støední Evropa (bìžný èas)

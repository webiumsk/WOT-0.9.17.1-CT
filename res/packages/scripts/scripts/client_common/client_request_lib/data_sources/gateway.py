# 2017.02.03 21:54:39 Støední Evropa (bìžný èas)
...
class GatewayDataAccessor(base.BaseDataAccessor):
    ...
    def account_statistics(self, callback, account_id, fields = None):
        ...
        return self._request_data(callback, url, get_data={}, converters={}, method='GET')
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client_common\client_request_lib\data_sources\gateway.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:40 Støední Evropa (bìžný èas)

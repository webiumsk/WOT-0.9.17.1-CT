# 2017.02.03 21:49:53 Støední Evropa (bìžný èas)
...
class FortOrderPopover(FortOrderPopoverMeta, FortViewHelper):
    ...
    def __getFortQuestBonusesStr(cls):
        ...
        return ', '.join(result)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortOrderPopover.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:54 Støední Evropa (bìžný èas)

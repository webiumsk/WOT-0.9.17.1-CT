# 2017.02.03 21:48:17 Støední Evropa (bìžný èas)
...
class VehComparisonBasket(IVehicleComparisonBasket):
    ...
    def __disposeCache(self):
        if self.__cache is not None:
            ...
            self.__cache = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\game_control\veh_comparison_basket.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:18 Støední Evropa (bìžný èas)

...
class TankExpertAchievement(HasVehiclesList, NationSpecificAchievement):
    ...
    def _parseVehiclesDescrsList(cls, name, dossier):
        if dossier is not None:
            ...
            return []
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\achievements\TankExpertAchievement.pyc 

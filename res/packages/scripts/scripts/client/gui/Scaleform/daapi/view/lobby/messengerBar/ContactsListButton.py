...
class ContactsListButton(ButtonWithCounterMeta):
    ...
    def __me_onUserActionReceived(self, actionID, user):
        ...
        self.__showContactsCount()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\messengerBar\ContactsListButton.pyc 

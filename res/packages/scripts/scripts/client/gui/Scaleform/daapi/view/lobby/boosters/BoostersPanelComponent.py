...
class BoostersPanelComponent(SlotsPanelMeta):
    ...
    def __onUpdateGoodies(self, *args):
        self._buildList()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\boosters\BoostersPanelComponent.pyc 

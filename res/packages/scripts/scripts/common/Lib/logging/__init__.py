...
def captureWarnings(capture):
    ...
    if capture:
        ...
        _warnings_showwarning = None
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\logging\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:59:43 Støední Evropa (bìžný èas)

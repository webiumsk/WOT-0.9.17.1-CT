# 2017.02.03 21:46:53 Støední Evropa (bìžný èas)
...
def _subtractPrices(price1, price2):
    return (price1[0] - price2[0], price1[1] - price2[1])
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\account_helpers\Shop.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:54 Støední Evropa (bìžný èas)

# 2017.02.03 21:52:54 Støední Evropa (bìžný èas)
...
class InventoryRequester(AbstractSyncDataRequester):
    ...
    def __getVehicleData(self, vehItemsData, invID):
        ...
        if invID not in vehItemsData['compDescr'].keys():
            ...
            return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\utils\requesters\InventoryRequester.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:55 Støední Evropa (bìžný èas)

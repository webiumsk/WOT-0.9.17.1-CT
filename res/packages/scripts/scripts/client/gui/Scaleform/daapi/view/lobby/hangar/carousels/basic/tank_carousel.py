...
class TankCarousel(TankCarouselMeta):
    ...
    def __onViewLoaded(self, view):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\carousels\basic\tank_carousel.pyc 

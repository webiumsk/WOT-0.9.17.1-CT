# 2017.02.03 21:50:41 Støední Evropa (bìžný èas)
...
class VehCompareBasketParamsCache(object):
    ...
    def __onVehParamsChanged(self, data):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_compare\cmp_parameters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:42 Støední Evropa (bìžný èas)

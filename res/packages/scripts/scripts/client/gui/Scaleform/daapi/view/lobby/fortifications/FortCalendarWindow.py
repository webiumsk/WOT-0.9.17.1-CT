...
class FortCalendarWindow(FortViewHelper, FortCalendarWindowMeta):
    ...
    def _getBattlesByDay(self):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortCalendarWindow.pyc 

# 2017.02.03 22:00:16 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    test()
    sys.exit(1)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\aetools.pyc 

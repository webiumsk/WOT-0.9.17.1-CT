# 2017.02.03 21:54:17 Støední Evropa (bìžný èas)
...
class GameAttribute(HasIDAndTarget):
    ...
    def getArgs(self):
        return self.__args
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\data\chapter.pyc 

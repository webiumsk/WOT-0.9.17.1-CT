...
class CrewAboutDogWindow(SimpleWindowMeta):
    ...
    def getBtnData(self):
        return [{'label': MENU.HANGAR_CREW_RODY_DOG_WINDOW_CLOSEBTNLABEL,
          ...
          'isFocused': True,
          'tooltip': ''}]
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\CrewAboutDogWindow.pyc 

# 2017.02.03 21:50:39 Støední Evropa (bìžný èas)
    ...
    def __notifyViews(self, event, *args, **kwargs):
        for component in self.__views.itervalues():
            ...
            if notifier and callable(notifier):
                ...
                self.closeView(VIEW_ALIAS.LOBBY_HANGAR)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\vehicle_compare\cmp_configurator_view.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:40 Støední Evropa (bìžný èas)

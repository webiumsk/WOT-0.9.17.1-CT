...
class Fire(EntityExtra):
    ...
    def checkUnderwater(self, vehicle, isVehicleUnderwater):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\vehicle_extras.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:47 Støední Evropa (bìžný èas)

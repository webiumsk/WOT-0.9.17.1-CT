# 2017.02.03 21:58:45 Støední Evropa (bìžný èas)
...
class AutoCompleteWindow:
    ...
    def hide_window(self):
        if not self.is_active():
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\AutoCompleteWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:58:46 Støední Evropa (bìžný èas)

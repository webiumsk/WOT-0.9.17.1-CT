# 2017.02.03 21:54:30 Støední Evropa (bìžný èas)
...
class TrackCrashAuditionWWISE(TrackCrashAudition):
    ...
    def playCrashSound(self, isLeft = True, restore = False):
        ...
        if replayCtrl.isPlaying and replayCtrl.isTimeWarpInProgress:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\vehicle_systems\components\vehicle_audition_wwise.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:31 Støední Evropa (bìžný èas)

# 2017.02.03 21:46:50 Støední Evropa (bìžný èas)
...
class CustomFilesCache(object):
    ...
    def __onPostTask(self, url, invokeAndReleaseCallbacks, file):
        ...
        for cb in cbs:
            cb(url, file)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\account_helpers\CustomFilesCache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:51 Støední Evropa (bìžný èas)

# 2017.02.03 21:52:12 Støední Evropa (bìžný èas)
...
def createByState(state, isLeader = False, exclude = None):
    ...
    return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\fortifications\controls.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:13 Støední Evropa (bìžný èas)

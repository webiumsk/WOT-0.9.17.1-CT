# 2017.02.03 21:53:40 Støední Evropa (bìžný èas)
...
class ServiceChannelManager(ChatActionsListener):
    ...
    def __addClientMessage(self, message, msgType, isAlert = False, auxData = None):
        ...
        return clientID
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\bw\ServiceChannelManager.pyc 

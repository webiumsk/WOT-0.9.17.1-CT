...
class FormatError(Error):
    ...
    pass
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\mailbox.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:56:21 Støední Evropa (bìžný èas)

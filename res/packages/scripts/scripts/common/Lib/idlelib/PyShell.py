# 2017.02.03 21:58:58 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    main()
capture_warnings(False)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\PyShell.pyc 

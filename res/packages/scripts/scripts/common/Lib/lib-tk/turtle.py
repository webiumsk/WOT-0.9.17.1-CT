# 2017.02.03 21:59:20 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    demo2()
    exitonclick()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\lib-tk\turtle.pyc 

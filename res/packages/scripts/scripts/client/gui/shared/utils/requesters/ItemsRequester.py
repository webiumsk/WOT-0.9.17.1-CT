...
class ItemsRequester(object):
    ...
    def __getVehicleCDForTankman(self, tmanData):
        ...
        if vehData is not None:
            ...
            return set()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\utils\requesters\ItemsRequester.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:56 Støední Evropa (bìžný èas)

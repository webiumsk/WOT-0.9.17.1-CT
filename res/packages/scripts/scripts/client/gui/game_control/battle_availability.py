# 2017.02.03 21:48:11 Støední Evropa (bìžný èas)
...
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\game_control\battle_availability.pyc 

# 2017.02.03 21:49:41 Støední Evropa (bìžný èas)
...
class MainView(CustomizationMainViewMeta):
    ...
    def __installElement(self, idx):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\customization\main_view.pyc 

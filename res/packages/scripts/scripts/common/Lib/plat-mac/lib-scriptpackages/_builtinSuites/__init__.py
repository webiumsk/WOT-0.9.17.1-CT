...
class _builtinSuites(builtin_Suite_Events, aetools.TalkTo):
    _signature = 'ascr'
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\lib-scriptpackages\_builtinSuites\__init__.pyc 

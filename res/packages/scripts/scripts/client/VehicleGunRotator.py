# 2017.02.03 21:46:45 Støední Evropa (bìžný èas)
...
class _PlayerTurretRotationSoundEffectWWISE(CallbackDelayer):
    ...
    def enable(self, enableSound):
        pass
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\VehicleGunRotator.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:46 Støední Evropa (bìžný èas)

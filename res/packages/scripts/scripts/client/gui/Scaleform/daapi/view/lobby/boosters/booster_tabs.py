# 2017.02.03 21:49:32 Støední Evropa (bìžný èas)
...
def _makeBoosterSlotVO(booster, count):
    return {'boosterId': booster.boosterID,
     ...
     'showLeftTime': False}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\boosters\booster_tabs.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:33 Støední Evropa (bìžný èas)

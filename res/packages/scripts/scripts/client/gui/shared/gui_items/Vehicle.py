# 2017.02.03 21:52:19 Støední Evropa (bìžný èas)
...
def getVehicleClassTag(tags):
    ...
    return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\Vehicle.pyc 

...
class TechnicalMaintenance(TechnicalMaintenanceMeta):
    ...
    def __getStatus(self, reason):
        if reason is not None:
            ...
            return ''
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\TechnicalMaintenance.pyc 

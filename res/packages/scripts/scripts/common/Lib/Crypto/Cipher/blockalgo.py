# 2017.02.03 21:57:38 Støední Evropa (bìžný èas)
...
class BlockAlgo:
    ...
    def decrypt_and_verify(self, ciphertext, mac_tag):
        ...
        self.verify(mac_tag)
        return pt
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\Crypto\Cipher\blockalgo.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:57:39 Støední Evropa (bìžný èas)

# 2017.02.03 21:55:06 Støední Evropa (bìžný èas)
...
class Source(object):
    ...
    def __readClubsSection(self, readersMapping, section, node):
        for name, sub in section.items():
            ...
            node.addChild(subNode)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\quest_xml_source.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:07 Støední Evropa (bìžný èas)

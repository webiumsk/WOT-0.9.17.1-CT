# 2017.02.03 21:59:03 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    root.mainloop()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\textView.pyc 

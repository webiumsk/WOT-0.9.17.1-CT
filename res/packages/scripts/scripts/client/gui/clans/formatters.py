# 2017.02.03 21:48:02 Støední Evropa (bìžný èas)
...
class ClanAppActionHtmlTextFormatter(object):
    ...
    def getText(self, clanName):
        ...
        if len(text):
            result.append(text)
        return ''.join(result)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\clans\formatters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:03 Støední Evropa (bìžný èas)

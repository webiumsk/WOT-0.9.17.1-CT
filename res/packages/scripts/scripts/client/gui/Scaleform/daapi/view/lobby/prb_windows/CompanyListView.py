...
class CompanyListView(CompanyListMeta, ILegacyListener):
    ...
    def __clearCallback(self):
        if self.__bwListCB is not None:
            ...
            self.__bwListCB = None
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\CompanyListView.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:14 Støední Evropa (bìžný èas)

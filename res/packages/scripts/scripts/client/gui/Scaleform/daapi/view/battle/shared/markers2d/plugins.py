# 2017.02.03 21:49:13 Støední Evropa (bìžný èas)
...
class EquipmentsMarkerPlugin(MarkerPlugin):
    ...
    def __handleCallback(self, markerID, finishTime):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\markers2d\plugins.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:14 Støední Evropa (bìžný èas)

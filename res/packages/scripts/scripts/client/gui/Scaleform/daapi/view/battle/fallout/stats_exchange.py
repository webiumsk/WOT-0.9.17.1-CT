# 2017.02.03 21:49:03 Støední Evropa (bìžný èas)
...
class FalloutStatisticsDataController(BattleStatisticsDataController):
    ...
    def __configureMultiTeamBroker(self, exchangeBroker):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\fallout\stats_exchange.pyc 

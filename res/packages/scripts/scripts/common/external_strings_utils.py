# 2017.02.03 21:54:55 Støední Evropa (bìžný èas)
...
def _decode_utf8_len_byte(byte):
    ...
    if v < 127:
        return 1
    return 0
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\external_strings_utils.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:56 Støední Evropa (bìžný èas)

...
class AutoInvitesRequester(IPrbListRequester):
    ...
    def __fetchList(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\battle_session\legacy\requester.pyc 

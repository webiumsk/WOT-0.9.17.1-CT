# 2017.02.03 21:56:04 Støední Evropa (bìžný èas)
...
class DocCGIXMLRPCRequestHandler(CGIXMLRPCRequestHandler, XMLRPCDocGenerator):
    ...
    def __init__(self):
        ...
        XMLRPCDocGenerator.__init__(self)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\DocXMLRPCServer.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:56:05 Støední Evropa (bìžný èas)

# 2017.02.03 21:57:34 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    for file in sys.argv[1:]:
        compileFile(file)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\compiler\pycodegen.pyc 

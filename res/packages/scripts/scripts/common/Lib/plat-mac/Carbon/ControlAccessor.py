# 2017.02.03 22:00:30 Støední Evropa (bìžný èas)
...
def GetControlData(control, part, selector):
    ...
    if type(data) == type(()) and len(data) == 1:
        data = data[0]
    return data
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\Carbon\ControlAccessor.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 22:00:31 Støední Evropa (bìžný èas)

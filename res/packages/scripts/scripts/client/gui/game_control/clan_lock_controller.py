# 2017.02.03 21:48:12 Støední Evropa (bìžný èas)
...
class ClanLockController(IClanLockController, Notifiable):
    ...
    def __notificationStartStop(self):
        if self.__isFullLock or self.__lockedVehicles:
            ...
            self.stopNotification()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\game_control\clan_lock_controller.pyc 

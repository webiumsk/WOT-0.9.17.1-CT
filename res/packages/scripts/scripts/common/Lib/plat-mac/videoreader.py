# 2017.02.03 22:00:28 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    _test()
    sys.exit(1)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\videoreader.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 22:00:29 Støední Evropa (bìžný èas)

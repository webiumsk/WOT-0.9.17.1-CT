# 2017.02.03 21:51:56 Støední Evropa (bìžný èas)
...
class ImageUrlProperties(object):
    ...
    def __init__(self, imageAlias, width = 16, height = 16, vSpace = -4, hSpace = 0):
        ...
        self.vSpace = vSpace
        self.hSpace = hSpace
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\managers\UtilsManager.pyc 

# 2017.02.03 21:48:13 Støední Evropa (bìžný èas)
...
class GameSessionController(IGameSessionController, Notifiable):
    ...
    def __getCurfewBlockTime(cls, restrictions):
        ...
        return (None, None)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\game_control\GameSessionController.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:14 Støední Evropa (bìžný èas)

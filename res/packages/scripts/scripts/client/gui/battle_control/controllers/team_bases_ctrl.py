# 2017.02.03 21:47:47 Støední Evropa (bìžný èas)
...
def createTeamsBasesCtrl(setup):
    ...
    return ctrl
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\battle_control\controllers\team_bases_ctrl.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:48 Støední Evropa (bìžný èas)

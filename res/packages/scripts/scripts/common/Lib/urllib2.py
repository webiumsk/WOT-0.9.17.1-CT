# 2017.02.03 21:57:07 Støední Evropa (bìžný èas)
...
class CacheFTPHandler(FTPHandler):
    ...
    def clear_cache(self):
        ...
        self.cache.clear()
        self.timeout.clear()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\urllib2.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:57:09 Støední Evropa (bìžný èas)

# 2017.02.03 21:52:47 Støední Evropa (bìžný èas)
...
class EquipmentPacker(HeaderPacker):
    ...
    def _packBlocks(self, *args, **kwargs):
        ...
        return items
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\tutorial.pyc 

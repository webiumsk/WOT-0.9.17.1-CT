...
class _PreviewLogicProvider(PopoverLogicProvider):
    ...
    def _buildModuleData(self, module, isInstalled, _):
        ...
        extendByModuleData(moduleData, module, self._vehicle.descriptor)
        return moduleData
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\shared\fitting_select_popover.pyc 

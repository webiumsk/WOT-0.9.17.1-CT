# 2017.02.03 21:50:26 Støední Evropa (bìžný èas)
...
class QuestsCurrentTab(QuestsCurrentTabMeta):
    ...
    def __onEventsUpdated(self, *args):
        ...
        self._invalidateEventsData()
        self._updateFilterView()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\QuestsCurrentTab.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:27 Støední Evropa (bìžný èas)

...
class SwitchPeripheryWindow(SwitchPeripheryWindowMeta):
    ...
    def __onServersUpdate(self, _):
        self._updateServersList()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\SwitchPeripheryWindow.pyc 

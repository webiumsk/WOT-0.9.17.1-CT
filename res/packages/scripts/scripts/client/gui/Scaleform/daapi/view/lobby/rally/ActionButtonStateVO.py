...
class ActionButtonStateVO(dict):
    ...
    def getInvalidVehicleLevelsMessage(ctx):
        if ctx is None:
            ...
            return (stateString, {})
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rally\ActionButtonStateVO.pyc 

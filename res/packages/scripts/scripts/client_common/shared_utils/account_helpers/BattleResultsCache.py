# 2017.02.03 21:54:41 Støední Evropa (bìžný èas)
...
def convertToFullForm(compactForm):
    ...
    return fullForm
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client_common\shared_utils\account_helpers\BattleResultsCache.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:42 Støední Evropa (bìžný èas)

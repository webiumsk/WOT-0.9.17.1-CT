...
class AutoInvitesNotifier(object):
    ...
    def __pe_onPrbAutoInvitesChanged(self):
        self.__doNotify()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\invites.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:28 Støední Evropa (bìžný èas)

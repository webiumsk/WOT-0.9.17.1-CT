# 2017.02.03 21:57:57 Støední Evropa (bìžný èas)
...
def ensure_relative(path):
    ...
    if path[0:1] == os.sep:
        path = drive + path[1:]
    return path
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\distutils\dir_util.pyc 

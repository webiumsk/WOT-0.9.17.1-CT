...
class CurrentUserEntity(UserEntity):
    ...
    def isCurrentPlayer(self):
        return True
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\entities.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:36 Støední Evropa (bìžný èas)

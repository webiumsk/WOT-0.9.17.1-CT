...
class RecruitParamsComponent(RecruitParametersMeta):
    ...
    def __getTankmanRoleEmptyRow(self):
        return {'id': None,
         'label': DIALOGS.RECRUITWINDOW_MENUEMPTYROW}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\recruitWindow\RecruitParamsComponent.pyc 

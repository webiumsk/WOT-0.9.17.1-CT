# 2017.02.03 21:53:34 Støední Evropa (bìžný èas)
...
class FAQWindow(FAQWindowMeta):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\FAQWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:35 Støední Evropa (bìžný èas)

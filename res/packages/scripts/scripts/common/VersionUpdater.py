# 2017.02.03 21:55:11 Støední Evropa (bìnı èas)
...
class VersionUpdaterBase(object):
    ...
    def _updateToLatestVersion(self, versionOrGetter, logID, *args):
        ...
        return args
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\VersionUpdater.pyc 

# 2017.02.03 21:47:12 Støední Evropa (bìžný èas)
...
def finiAttackManager():
    ...
    _g_instance = None
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\battleground\gas_attack.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:13 Støední Evropa (bìžný èas)

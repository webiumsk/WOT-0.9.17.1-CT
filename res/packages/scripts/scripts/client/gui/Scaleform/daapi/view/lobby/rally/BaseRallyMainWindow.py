...
class BaseRallyMainWindow(BaseRallyMainWindowMeta, IGlobalListener):
    ...
    def _loadBrowserView(self, prbType):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\rally\BaseRallyMainWindow.pyc 

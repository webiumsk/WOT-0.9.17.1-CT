# 2017.02.03 21:46:57 Støední Evropa (bìžný èas)
...
class ServerSettingsManager(object):
    ...
    def _setSettingsSections(self, data):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\account_helpers\settings_core\ServerSettingsManager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:58 Støední Evropa (bìžný èas)

# 2017.02.03 21:48:09 Støední Evropa (bìžný èas)
...
class GuiSoundsLoader(object):
    ...
    def getEffectSound(self, effectName):
        ...
        if effectName in self.__effects:
            ...
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\doc_loaders\GuiSoundsLoader.pyc 

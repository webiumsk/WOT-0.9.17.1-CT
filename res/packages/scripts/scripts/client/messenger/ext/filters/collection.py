# 2017.02.03 21:53:20 Støední Evropa (bìžný èas)
...
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\ext\filters\collection.pyc 

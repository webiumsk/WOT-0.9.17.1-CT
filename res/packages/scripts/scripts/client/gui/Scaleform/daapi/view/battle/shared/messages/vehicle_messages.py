...
class VehicleMessages(fading_messages.FadingMessages):
    ...
    def __formatEntity(self, entityID):
        ...
        return entityInfo
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\messages\vehicle_messages.pyc 

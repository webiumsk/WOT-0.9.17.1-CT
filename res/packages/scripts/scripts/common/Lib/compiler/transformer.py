# 2017.02.03 21:57:36 Støední Evropa (bìžný èas)
...
def debug_tree(tree):
    ...
    return l
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\compiler\transformer.pyc 

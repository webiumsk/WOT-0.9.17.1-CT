...
class ResponseDictHandler(ResponseHandler):
    ...
    def excludeRqsByValue(self, value):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\bw_chat2\provider.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:43 Støední Evropa (bìžný èas)

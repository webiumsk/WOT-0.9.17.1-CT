...
class FortReserveSelectPopover(FittingSelectPopoverMeta, IUnitListener):
    ...
    def __buildList(self):
        ...
        if data is None:
            ...
            return modulesList
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortReserveSelectPopover.pyc 

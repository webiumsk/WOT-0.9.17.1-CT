# 2017.02.03 21:55:40 Støední Evropa (bìžný èas)
...
def init():
    ...
    if g_cache is not None:
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\items\qualifiers\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:41 Støední Evropa (bìžný èas)

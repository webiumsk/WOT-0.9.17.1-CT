...
class CyberSportMainWindow(CyberSportMainWindowMeta):
    ...
    def __updateChatAvailability(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\cyberSport\CyberSportMainWindow.pyc 

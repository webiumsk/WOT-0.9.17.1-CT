# 2017.02.03 21:49:51 Støední Evropa (bìžný èas)
...
class FortDisableDefencePeriodWindow(FortDisableDefencePeriodWindowMeta, FortViewHelper):
    ...
    def __setup(self):
        ...
        self.destroy()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortDisableDefencePeriodWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:52 Støední Evropa (bìžný èas)

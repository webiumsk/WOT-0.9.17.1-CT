...
def packGroupBlock(groupName, bgImg = None):
    ...
    return {'isTitle': True,
     ...
     'bckgrImage': bgImg}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\server_events\formatters.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:04 Støední Evropa (bìžný èas)

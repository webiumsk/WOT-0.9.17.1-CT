# 2017.02.03 21:53:46 Støední Evropa (bìžný èas)
...
class ClientEventsHandler(ClientHolder):
    ...
    def unregisterHandlers(self):
        raise NotImplementedError
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\gloox_wrapper.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:47 Støední Evropa (bìžný èas)

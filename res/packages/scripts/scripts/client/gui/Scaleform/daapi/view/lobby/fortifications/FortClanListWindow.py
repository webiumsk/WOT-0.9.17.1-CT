...
class FortClanListWindow(FortClanListWindowMeta, FortViewHelper):
    ...
    def onClientStateChanged(self, state):
        if state.getStateID() == CLIENT_FORT_STATE.DISABLED:
            self.onWindowClose()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortClanListWindow.pyc 

# 2017.02.03 21:54:12 Støední Evropa (bìžný èas)
    ...
    def __pe_onArenaPeriodChange(self, period, *args):
        if period is ARENA_PERIOD.BATTLE:
            ...
            if self.__isDelayPerformed():
                avatar_getter.leaveArena()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\control\battle\functional.pyc 

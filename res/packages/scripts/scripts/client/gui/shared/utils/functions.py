...
def showSentInviteMessage(user = None):
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\utils\functions.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:51 Støední Evropa (bìžný èas)

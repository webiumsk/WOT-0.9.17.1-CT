...
class ToolTip(ToolTipMgrMeta):
    ...
    def __getTags(self, block_type, format_type):
        ...
        return ['', '']
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\framework\ToolTip.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:51:13 Støední Evropa (bìžný èas)

    ...
    def __makeSLotData(self, idx):
        return {'nationIDRange': ['ussr',
         ...
         'vTypeRange': ['lightTank',
                        ...
                        'AT-SPG',
                        'SPG'] if idx == 2 else []}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\popover\RangeRequirementsVehiclePopover.pyc 

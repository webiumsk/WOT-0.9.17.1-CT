...
class ClanProfileFortificationInfoView(ClanProfileFortificationInfoViewMeta):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileFortificationInfoView.pyc 

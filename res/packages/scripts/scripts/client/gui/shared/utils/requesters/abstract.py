# 2017.02.03 21:52:53 Støední Evropa (bìžný èas)
...
class ClientRequestsByIDProcessor(RequestsByIDProcessor):
    ...
    def fini(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\utils\requesters\abstract.pyc 

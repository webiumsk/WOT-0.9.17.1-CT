# 2017.02.03 21:48:53 Støední Evropa (bìžný èas)
...
class StrongholdDataDiffer(object):
    ...
    def makeDiff(self, data):
        ...
        self._data = data
        return diff
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\items\stronghold_items.pyc 

# 2017.02.03 22:00:26 Støední Evropa (bìžný èas)
...
def _decode(pathname, verbose = 0):
    ...
    return newpathname
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\macresource.pyc 

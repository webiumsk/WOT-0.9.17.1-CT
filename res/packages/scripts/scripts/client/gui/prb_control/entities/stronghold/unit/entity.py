# 2017.02.03 21:48:47 Støední Evropa (bìžný èas)
...
class StrongholdEntity(UnitEntity):
    ...
    def __updateMatchmakingData(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\stronghold\unit\entity.pyc 

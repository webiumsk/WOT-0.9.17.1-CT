...
class UsersInfoHelper(object):
    ...
    def syncUsersInfo(self):
        ...
        self._invalid.clear()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\view_helpers\UsersInfoHelper.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:59 Støední Evropa (bìžný èas)

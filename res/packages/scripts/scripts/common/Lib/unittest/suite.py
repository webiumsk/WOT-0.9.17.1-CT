# 2017.02.03 22:00:56 Støední Evropa (bìžný èas)
...
class _DebugResult(object):
    ...
    shouldStop = False
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\unittest\suite.pyc 

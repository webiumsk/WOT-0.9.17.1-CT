# 2017.02.03 21:53:26 Støední Evropa (bìžný èas)
...
class BattleControllersFactory(IControllerFactory):
    ...
    def factory(self, channel):
        ...
        return controller
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\channels\bw_chat2\factories.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:27 Støední Evropa (bìžný èas)

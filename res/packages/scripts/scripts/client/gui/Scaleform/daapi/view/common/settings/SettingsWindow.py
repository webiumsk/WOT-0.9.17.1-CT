...
class SettingsWindow(SettingsWindowMeta):
    ...
    def __isGraphicsPresetApplied(self, settings):
        ...
        return True
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\common\settings\SettingsWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:20 Støední Evropa (bìžný èas)

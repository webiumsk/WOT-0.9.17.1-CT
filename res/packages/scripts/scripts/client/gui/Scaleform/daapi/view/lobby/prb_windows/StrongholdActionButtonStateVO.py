...
class StrongholdActionButtonStateVO(ActionButtonStateVO):
    ...
    def _getLabel(self):
        ...
        return label
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\StrongholdActionButtonStateVO.pyc 

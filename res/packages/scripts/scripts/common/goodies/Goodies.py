# 2017.02.03 21:55:30 Støední Evropa (bìžný èas)
...
class Goodies(object):
    ...
    def remove(self, goodieID, goodie = None, goodieDefinition = None, count = 1):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\goodies\Goodies.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:31 Støední Evropa (bìžný èas)

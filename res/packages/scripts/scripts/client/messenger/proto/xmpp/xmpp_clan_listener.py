...
class XmppClanListener(ClientHolder):
    ...
    def __checkForLeave(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\xmpp_clan_listener.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:49 Støední Evropa (bìžný èas)

...
class SimpleProgressAchievement(RegularAchievement):
    ...
    def _readProgressValue(self, dossier):
        return 0
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\achievements\abstract\SimpleProgressAchievement.pyc 

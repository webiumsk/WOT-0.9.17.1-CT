# 2017.02.03 21:47:41 Støední Evropa (bìžný èas)
...
class FalloutMultiTeamItemsCollection(VehiclesItemsCollection):
    ...
    def _sortIfNeed(self, seq):
        ...
        return seq
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\battle_control\arena_info\vos_collections.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:42 Støední Evropa (bìžný èas)

# 2017.02.03 21:52:15 Støední Evropa (bìžný èas)
...
class DefenceItem(_BattleItemAbstract):
    ...
    def isLose(self):
        return self.isResultsPresent() and self._attackResult > 0 or self._attackResult == FORT_ATTACK_RESULT.TECHNICAL_DRAW
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\fortifications\fort_seqs.pyc 

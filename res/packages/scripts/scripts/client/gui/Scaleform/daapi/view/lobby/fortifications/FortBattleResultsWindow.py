...
class FortBattleResultsWindow(FortBattleResultsWindowMeta):
    ...
    def _populate(self):
        ...
        self.__updateData()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortBattleResultsWindow.pyc 

# 2017.02.03 21:57:01 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    test()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\telnetlib.pyc 

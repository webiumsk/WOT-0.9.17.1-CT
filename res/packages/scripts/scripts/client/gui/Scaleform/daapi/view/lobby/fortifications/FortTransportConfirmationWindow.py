...
class FortTransportConfirmationWindow(FortTransportConfirmationWindowMeta, FortViewHelper):
    ...
    def __changeStateAndDestroy(self):
        ...
        self.destroy()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortTransportConfirmationWindow.pyc 

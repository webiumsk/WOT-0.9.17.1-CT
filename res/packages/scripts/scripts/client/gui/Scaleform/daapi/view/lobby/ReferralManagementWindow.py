...
class ReferralManagementWindow(ReferralManagementWindowMeta, IGlobalListener, Notifiable):
    ...
    def __onRefSystemQuestsUpdated(self):
        self.__update()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\ReferralManagementWindow.pyc 

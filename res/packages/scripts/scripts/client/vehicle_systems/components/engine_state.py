# 2017.02.03 21:54:29 Støední Evropa (bìžný èas)
...
class DetailedEngineStateWWISE(DetailedEngineState):
    ...
    def refresh(self, dt):
        if self._vehicle is None:
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\vehicle_systems\components\engine_state.pyc 

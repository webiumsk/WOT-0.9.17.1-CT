# 2017.02.03 21:47:34 Støední Evropa (bìžný èas)
...
class ReplayWaiting(WaitingState):
    ...
    def _getNextState(self, ctx):
        if ctx.guiSpaceID == _SPACE_ID.BATTLE_LOADING:
            ...
            newState = None
        return newState
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\app_loader\states.pyc 

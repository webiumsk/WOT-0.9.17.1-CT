...
class PostmortemPanel(_SummaryPostmortemPanel):
    ...
    def __onSettingsChanged(self, diff):
        if GRAPHICS.COLOR_BLIND in diff:
            ...
            self.__deathAlreadySet = False
            self.__updateVehicleInfo()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\postmortem_panel.pyc 

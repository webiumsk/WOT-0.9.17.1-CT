# 2017.02.03 21:50:28 Støední Evropa (bìžný èas)
...
class TutorialQuestsTab(QuestsCurrentTab):
    ...
    def _updateFilterView(self):
        pass
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\TutorialQuestsTab.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:29 Støední Evropa (bìžný èas)

# 2017.02.03 21:52:01 Støední Evropa (bìžný èas)
...
class EventsCache(IEventsCache):
    ...
    def __onLockedQuestsChanged(self):
        self.__lockedQuestIds = BigWorld.player().potapovQuestsLock
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\server_events\EventsCache.pyc 

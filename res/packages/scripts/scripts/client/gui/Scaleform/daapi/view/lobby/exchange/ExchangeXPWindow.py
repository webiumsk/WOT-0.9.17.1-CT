...
class ExchangeXPWindow(ExchangeXpWindowMeta):
    ...
    def __getActionStyle(self):
        ...
        if rate != actionRate and actionRate > 0:
            return 'statsText'
        return 'alertText'
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\exchange\ExchangeXPWindow.pyc 

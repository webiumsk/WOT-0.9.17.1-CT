    ...
    def onBuildingChanged(self, buildingTypeID, reason, ctx = None):
        if reason == BUILDING_UPDATE_REASON.DELETED:
            ...
            if order.buildingID == buildingTypeID:
                self.destroy()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortOrderConfirmationWindow.pyc 

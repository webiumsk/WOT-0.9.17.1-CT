...
class ClanUserRoomController(UserRoomController):
    ...
    def __me_onErrorReceived(self, error):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\channels\xmpp\lobby_controllers.pyc 

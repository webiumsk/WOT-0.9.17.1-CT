...
class CrosshairPanelContainer(ExternalFlashComponent, CrosshairPanelContainerMeta):
    ...
    def __clearGunMarkers(self):
        if self.__gunMarkers is None:
            ...
            self.__gunMarkers = None
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\crosshair\container.pyc 

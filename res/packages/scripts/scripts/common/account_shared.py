...
def readClientServerVersion():
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\account_shared.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:44 Støední Evropa (bìžný èas)

...
class FortBattleRoomOrdersPanelComponent(SlotsPanelMeta, FortViewHelper, IUnitListener):
    ...
    def __updateSlots(self):
        if not self._isConsumablesAvailable():
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortBattleRoomOrdersPanelComponent.pyc 

# 2017.02.03 21:56:42 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    _test()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\random.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:56:43 Støední Evropa (bìžný èas)

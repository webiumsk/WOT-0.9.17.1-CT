# 2017.02.03 21:46:40 Støední Evropa (bìžný èas)
...
def LSstartAll():
    if WWISE.enabled and ENABLE_LS:
        WWISE.LSstartAll()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\SoundGroups.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:41 Støední Evropa (bìžný èas)

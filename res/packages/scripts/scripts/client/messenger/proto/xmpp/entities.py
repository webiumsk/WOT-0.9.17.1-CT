# 2017.02.03 21:53:45 Støední Evropa (bìžný èas)
...
class XMPPMUCOccupant(_XMPPMemberEntity):
    ...
    def __init__(self, jid, nickName, dbID = 0L, presence = PRESENCE.AVAILABLE, info = None):
        ...
        if info is not None:
            ...
            self._role = 'none'
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\entities.pyc 

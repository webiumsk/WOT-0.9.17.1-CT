...
class ContactsTreeComponent(ContactsTreeComponentMeta):
    ...
    def __onTotalStatusChanged(self):
        self._updateListState()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\ContactsTreeComponent.pyc 

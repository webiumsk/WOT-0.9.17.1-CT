...
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\items\artefacts.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:32 Støední Evropa (bìžný èas)

# 2017.02.03 21:53:28 Støední Evropa (bìžný èas)
...
class ContactsDataProvider(DAAPIDataProvider):
    ...
    def __me_onNotesListReceived(self):
        self.buildList()
        self.refresh()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\data\contacts_data_provider.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:29 Støední Evropa (bìžný èas)

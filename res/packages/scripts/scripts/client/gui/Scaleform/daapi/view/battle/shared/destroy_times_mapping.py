...
class FrontendMapping(object):
    ...
    def __loadDeathZoneSounds(soundsIDs):
        ...
        return sounds
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\destroy_times_mapping.pyc 

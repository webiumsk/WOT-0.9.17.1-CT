...
class CompaniesDataProvider(DAAPIDataProvider):
    ...
    def setPlayers(self, prbID, roster):
        ...
        return foundIdx
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\companies_dps.pyc 

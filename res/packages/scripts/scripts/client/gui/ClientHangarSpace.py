# 2017.02.03 21:47:30 Støední Evropa (bìžný èas)
...
def _createMatrix(scale, angles, pos):
    ...
    return mat
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\ClientHangarSpace.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:31 Støední Evropa (bìžný èas)

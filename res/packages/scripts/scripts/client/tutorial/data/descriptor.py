# 2017.02.03 21:54:18 Støední Evropa (bìžný èas)
...
class DescriptorData(object):
    ...
    def getChapterByIdx(self, idx):
        if idx < len(self.__contents):
            ...
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\data\descriptor.pyc 

...
class MotiveQuestDetails(TutorialHangarQuestDetailsMeta):
    ...
    def requestQuestInfo(self, questID):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\MotiveQuestsDetails.pyc 

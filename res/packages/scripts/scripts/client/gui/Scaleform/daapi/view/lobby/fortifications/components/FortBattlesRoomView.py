...
class FortBattlesRoomView(FortRoomMeta, FortViewHelper):
    ...
    def __onSettingsChanged(self, diff):
        if 'isFortsEnabled' in diff:
            self._setActionButtonState()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\FortBattlesRoomView.pyc 

# 2017.02.03 21:51:54 Støední Evropa (bìžný èas)
...
class BattleColorSchemeManager(ColorSchemeManager, IArenaVehiclesController):
    ...
    def __onTeamChanged(self, teamID):
        self.__set3DFlagsColors()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\managers\ColorSchemeManager.pyc 

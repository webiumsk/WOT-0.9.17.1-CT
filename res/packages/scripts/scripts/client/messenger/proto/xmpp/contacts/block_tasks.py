# 2017.02.03 21:53:50 Støední Evropa (bìžný èas)
...
class SyncBlockItemTask(IQTask):
    ...
    def set(self, pyGlooxTag):
        ...
        return self._result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\proto\xmpp\contacts\block_tasks.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:53:51 Støední Evropa (bìžný èas)

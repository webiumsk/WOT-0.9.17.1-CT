# 2017.02.03 21:49:06 Støední Evropa (bìžný èas)
...
class DestroyTimersPanel(DestroyTimersPanelMeta):
    ...
    def __onCameraChanged(self, ctrlMode, vehicleID = None):
        if ctrlMode == 'video':
            self.__hideAll()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\destroy_timers_panel.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:07 Støední Evropa (bìžný èas)

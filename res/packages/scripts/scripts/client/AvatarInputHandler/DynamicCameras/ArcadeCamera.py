# 2017.02.03 21:47:10 Støední Evropa (bìžný èas)
...
class ArcadeCamera(ICamera, CallbackDelayer, TimeDeltaMeter):
    ...
    def __onRecreateDevice(self):
        self.__aimingSystem.aimMatrix = self.__calcAimMatrix()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\AvatarInputHandler\DynamicCameras\ArcadeCamera.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:11 Støední Evropa (bìžný èas)

...
class BasicTestRunner:
    ...
    def run(self, test):
        ...
        test(result)
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\ctypes\test\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:57:54 Støední Evropa (bìžný èas)

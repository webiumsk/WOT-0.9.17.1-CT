...
class MarkCellPlugin(common.AttentionToCellPlugin):
    ...
    def _doAttention(self, index, duration):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\classic\minimap.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:00 Støední Evropa (bìžný èas)

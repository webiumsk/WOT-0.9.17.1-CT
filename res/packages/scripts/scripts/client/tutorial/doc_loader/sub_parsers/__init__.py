# 2017.02.03 21:54:21 Støední Evropa (bìžný èas)
...
def parseHint(xmlCtx, section):
    ...
    return sectionInfo
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\doc_loader\sub_parsers\__init__.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:22 Støední Evropa (bìžný èas)

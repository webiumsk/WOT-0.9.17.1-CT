# 2017.02.03 21:49:42 Støední Evropa (bìžný èas)
...
class BonusTooltip(BlocksTooltipData):
    ...
    def __aggregateBonusesInfo(self, singleBonusData):
        ...
        return bonusVOs
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\customization\tooltips\bonus.pyc 

...
class VibroManager:
    ...
    def update(self):
        if not self.canWork():
            ...
            return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\Vibroeffects\VibroManager.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:32 Støední Evropa (bìžný èas)

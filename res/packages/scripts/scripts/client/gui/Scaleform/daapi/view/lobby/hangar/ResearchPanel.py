# 2017.02.03 21:50:05 Støední Evropa (bìžný èas)
...
class ResearchPanel(ResearchPanelMeta):
    ...
    def __getVehCompareData(self, vehicle):
        ...
        return {'modeAvailable': self.comparisonBasket.isEnabled(),
         'btnEnabled': state,
         'btnTooltip': tooltip}
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\ResearchPanel.pyc 

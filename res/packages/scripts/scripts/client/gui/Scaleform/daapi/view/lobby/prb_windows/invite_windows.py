...
class AutoInviteWindow(_InviteWindow):
    ...
    def __onPrbAutoInvitesChanged(self):
        if self._inviteInfo.getID() not in getPrebattleAutoInvites():
            self.destroy()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\prb_windows\invite_windows.pyc 

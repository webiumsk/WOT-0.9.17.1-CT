...
class ConnectToSecureChannelWindow(ConnectToSecureChannelWindowMeta):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\ConnectToSecureChannelWindow.pyc 

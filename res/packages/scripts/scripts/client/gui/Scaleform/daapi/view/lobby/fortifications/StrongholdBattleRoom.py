# 2017.02.03 21:49:56 Støední Evropa (bìžný èas)
...
class StrongholdBattleRoom(FortClanBattleRoomMeta, IUnitListener, IStrongholdListener, MethodsRules, UsersInfoHelper):
    ...
    def __unitActive(self):
        ...
        return unitActive
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\StrongholdBattleRoom.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:57 Støední Evropa (bìžný èas)

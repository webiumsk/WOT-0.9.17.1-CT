...
def _getWgshHost():
    ...
    return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\clans\clan_helpers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:01 Støední Evropa (bìžný èas)

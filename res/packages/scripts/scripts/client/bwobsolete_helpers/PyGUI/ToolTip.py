# 2017.02.03 21:47:21 Støední Evropa (bìžný èas)
...
class ToolTipManager(object):
    ...
    def _showToolTip(self, component, toolTipInfo):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\bwobsolete_helpers\PyGUI\ToolTip.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:22 Støední Evropa (bìžný èas)

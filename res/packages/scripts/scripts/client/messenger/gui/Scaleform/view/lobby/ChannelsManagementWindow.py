# 2017.02.03 21:53:33 Støední Evropa (bìžný èas)
...
class ChannelsManagementWindow(ChannelsManagementWindowMeta, ISearchHandler):
    ...
    def _dispose(self):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\view\lobby\ChannelsManagementWindow.pyc 

# 2017.02.03 22:00:07 Støední Evropa (bìžný èas)
...
class Cddb:
    ...
    def write(self):
        ...
        f.close()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-irix5\cddb.pyc 

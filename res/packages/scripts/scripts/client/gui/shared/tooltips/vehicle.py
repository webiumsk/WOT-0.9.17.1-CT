# 2017.02.03 21:52:48 Støední Evropa (bìžný èas)
...
def _getNeedValue(price, currency):
    ...
    if neededValue > 0:
        ...
        return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\tooltips\vehicle.pyc 

# 2017.02.03 21:55:03 Støední Evropa (bìžný èas)
...
class _Line:
    ...
    def strarray(self):
        return ['  <line x1="%d" y1="%d" x2="%d" y2="%d" />\n' % (self.start[0],
          ...
          self.end[0],
          self.end[1])]
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\PhysicsTurretShape.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:55:04 Støední Evropa (bìžný èas)

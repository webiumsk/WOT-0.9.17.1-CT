# 2017.02.03 21:46:28 Støední Evropa (bìžný èas)
...
class ClientSelectableObject(BigWorld.Entity):
    ...
    def onClicked(self):
        if self.__clickSound is None:
            ...
            self.__clickSound.play()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\ClientSelectableObject.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:46:29 Støední Evropa (bìžný èas)

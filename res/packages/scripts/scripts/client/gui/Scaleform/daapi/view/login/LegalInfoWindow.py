# 2017.02.03 21:50:43 Støední Evropa (bìžný èas)
...
class LegalInfoWindow(LegalInfoWindowMeta):
    ...
    def onWindowClose(self):
        self.destroy()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\login\LegalInfoWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:44 Støední Evropa (bìžný èas)

...
class ProfileStatistics(ProfileStatisticsMeta):
    ...
    def onCompletedSeasonsInfoChanged(self):
        self._setInitData()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\ProfileStatistics.pyc 

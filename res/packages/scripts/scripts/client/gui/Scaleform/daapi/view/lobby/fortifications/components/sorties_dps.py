# 2017.02.03 21:50:01 Støední Evropa (bìžný èas)
...
class FortBattlesDataProvider(SortableDAAPIDataProvider):
    ...
    def __makeTimeOfBattle(self, item, battleItem, currentState):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\sorties_dps.pyc 

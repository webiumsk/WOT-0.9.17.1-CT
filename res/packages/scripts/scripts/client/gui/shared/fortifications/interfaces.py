# 2017.02.03 21:52:16 Støední Evropa (bìžný èas)
...
class IFortValidators(object):
    ...
    def validate(self, requestType, *args):
        ...
        return (True, '')
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\fortifications\interfaces.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:17 Støední Evropa (bìžný èas)

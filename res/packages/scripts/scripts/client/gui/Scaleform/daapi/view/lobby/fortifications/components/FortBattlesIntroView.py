# 2017.02.03 21:49:58 Støední Evropa (bìžný èas)
...
class FortBattlesIntroView(FortIntroMeta, FortViewHelper):
    ...
    def __getButtonData(self):
        if self.fortState.getStateID() == CLIENT_FORT_STATE.HAS_FORT:
            ...
            return (False, '', None)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\components\FortBattlesIntroView.pyc 

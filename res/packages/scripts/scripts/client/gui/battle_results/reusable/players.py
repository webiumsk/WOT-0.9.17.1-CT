# 2017.02.03 21:47:56 Støední Evropa (bìžný èas)
...
class PlayersInfo(shared.UnpackedInfo):
    ...
    def getFirstEnemyClan(self, team):
        ...
        result = findFirst(lambda player: player.clanDBID and player.team != team, self.__players.itervalues(), PlayerInfo())
        return result.clanInfo
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\battle_results\reusable\players.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:57 Støední Evropa (bìžný èas)

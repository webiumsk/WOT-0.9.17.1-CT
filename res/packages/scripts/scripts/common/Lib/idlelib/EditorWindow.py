# 2017.02.03 21:58:51 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        run(_Help_dialog)
    run(_Editor_window)
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\idlelib\EditorWindow.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:58:53 Støední Evropa (bìžný èas)

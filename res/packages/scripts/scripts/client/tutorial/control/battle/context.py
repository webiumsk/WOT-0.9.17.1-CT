# 2017.02.03 21:54:11 Støední Evropa (bìžný èas)
...
class BattleSoundPlayer(context.SoundPlayer):
    ...
    def __onSpeakingStop(self, sound):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\tutorial\control\battle\context.pyc 

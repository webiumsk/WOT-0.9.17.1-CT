# 2017.02.03 21:58:03 Støední Evropa (bìžný èas)
...
def rfc822_escape(header):
    ...
    return header
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\distutils\util.pyc 

# 2017.02.03 21:48:56 Støední Evropa (bìžný èas)
...
class SystemMessagesInterface(ISystemMessages):
    ...
    def __processNotifications(self, notifications, state):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\SystemMessagesInterface.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:57 Støední Evropa (bìžný èas)

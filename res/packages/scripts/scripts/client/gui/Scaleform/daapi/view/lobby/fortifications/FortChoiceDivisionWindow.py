...
class FortChoiceDivisionWindow(FortChoiceDivisionWindowMeta):
    ...
    def __makeDivisionsData(self, list):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\fortifications\FortChoiceDivisionWindow.pyc 

...
def getModifierObj(name, params):
    if name in _MODIFIERS_DICT:
        ...
        return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\server_events\modifiers.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:52:05 Støední Evropa (bìžný èas)

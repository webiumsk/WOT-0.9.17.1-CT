# 2017.02.03 21:54:49 Støední Evropa (bìžný èas)
...
def decompressSysMessage(message):
    ...
    return message
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\chat_shared.pyc 

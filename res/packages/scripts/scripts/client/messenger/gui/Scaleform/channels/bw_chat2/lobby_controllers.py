...
class ClubChannelController(LobbyChannelController):
    ...
    def _onMembersListChanged(self):
        self._refreshMembersDP()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\messenger\gui\Scaleform\channels\bw_chat2\lobby_controllers.pyc 

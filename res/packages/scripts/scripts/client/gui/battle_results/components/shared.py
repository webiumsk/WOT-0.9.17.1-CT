...
class BiDiStatsBlock(base.StatsBlock):
    ...
    def right(self):
        ...
        return component
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\battle_results\components\shared.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:47:55 Støední Evropa (bìžný èas)

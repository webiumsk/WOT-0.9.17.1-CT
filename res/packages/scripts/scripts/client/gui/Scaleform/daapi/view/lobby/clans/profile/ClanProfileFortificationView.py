# 2017.02.03 21:49:36 Støední Evropa (bìžný èas)
...
class ClanProfileFortificationView(ClanProfileFortificationViewMeta, FortListener):
    ...
    def __showDummyBody(self):
        self.as_showBodyDummyS({'iconSource': RES_ICONS.MAPS_ICONS_LIBRARY_ALERTBIGICON,
         ...
         'btnLabel': '',
         'btnTooltip': ''})
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\clans\profile\ClanProfileFortificationView.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:49:37 Støední Evropa (bìžný èas)

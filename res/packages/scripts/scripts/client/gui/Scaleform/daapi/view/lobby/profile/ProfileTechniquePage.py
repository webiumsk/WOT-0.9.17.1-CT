# 2017.02.03 21:50:18 Støední Evropa (bìžný èas)
...
class ProfileTechniquePage(ProfileTechniquePageMeta):
    ...
    def requestData(self, vehicleId):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\ProfileTechniquePage.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:50:19 Støední Evropa (bìžný èas)

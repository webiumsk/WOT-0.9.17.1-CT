# 2017.02.03 21:54:26 Støední Evropa (bìžný èas)
...
def dCacheStatus():
    ...
    return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\vehicle_systems\appearance_cache.pyc 

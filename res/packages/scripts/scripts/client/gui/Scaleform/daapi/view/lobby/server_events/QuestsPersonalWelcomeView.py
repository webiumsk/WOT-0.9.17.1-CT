...
class QuestsPersonalWelcomeView(QuestsPersonalWelcomeViewMeta):
    ...
    def __makeBlocksData(self):
        ...
        return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\server_events\QuestsPersonalWelcomeView.pyc 

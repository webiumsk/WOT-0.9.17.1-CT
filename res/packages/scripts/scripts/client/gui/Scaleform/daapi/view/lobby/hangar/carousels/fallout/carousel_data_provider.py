...
class FalloutCarouselDataProvider(CarouselDataProvider):
    ...
    def _getVehicleDataVO(self, vehicle):
        ...
        return vehicleData
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\hangar\carousels\fallout\carousel_data_provider.pyc 

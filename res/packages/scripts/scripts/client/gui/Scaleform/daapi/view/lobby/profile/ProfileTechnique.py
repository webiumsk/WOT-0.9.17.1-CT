...
class ProfileTechnique(ProfileTechniqueMeta):
    ...
    def __getAchievementsList(self, targetData, vehDossier):
        ...
        return packedList
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\profile\ProfileTechnique.pyc 

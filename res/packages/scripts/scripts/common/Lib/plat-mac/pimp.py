# 2017.02.03 22:00:27 Støední Evropa (bìžný èas)
...
if __name__ == '__main__':
    main()
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\plat-mac\pimp.pyc 

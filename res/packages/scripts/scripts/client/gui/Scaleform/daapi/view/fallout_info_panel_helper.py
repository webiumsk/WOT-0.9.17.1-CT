# 2017.02.03 21:48:58 Støední Evropa (bìžný èas)
...
def getHelpText(arenaVisitor):
    ...
    return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\fallout_info_panel_helper.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:48:59 Støední Evropa (bìžný èas)

# 2017.02.03 21:49:15 Støední Evropa (bìžný èas)
...
class EquipmentsPlugin(common.IntervalPlugin):
    ...
    def __onEquipmentMarkerShown(self, equipment, position, _, interval):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\battle\shared\minimap\plugins.pyc 

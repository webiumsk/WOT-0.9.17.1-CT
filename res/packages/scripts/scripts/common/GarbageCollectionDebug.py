# 2017.02.03 21:54:58 Støední Evropa (bìžný èas)
...
def getObjectReferrers(obj, ignore):
    ...
    return result
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\GarbageCollectionDebug.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:59 Støední Evropa (bìžný èas)

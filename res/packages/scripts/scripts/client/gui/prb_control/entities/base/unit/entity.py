# 2017.02.03 21:48:35 Støední Evropa (bìžný èas)
...
class UnitEntity(_UnitEntity):
    ...
    def _isInCoolDown(self, requestType, callback = None, coolDown = None):
        ...
        if self._cooldown.validate(requestType, coolDown):
            ...
            return True
        return False
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\prb_control\entities\base\unit\entity.pyc 

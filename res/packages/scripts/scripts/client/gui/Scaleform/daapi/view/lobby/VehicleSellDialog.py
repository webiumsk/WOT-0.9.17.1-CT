# 2017.02.03 21:49:29 Støední Evropa (bìžný èas)
...
class VehicleSellDialog(VehicleSellDialogMeta):
    ...
    def __shopResyncHandler(self, reason, diff):
        ...
        if reason == CACHE_SYNC_REASON.SHOP_RESYNC or vehicle is not None and vehicle.rentalIsActive:
            self.onWindowClose()
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\Scaleform\daapi\view\lobby\VehicleSellDialog.pyc 

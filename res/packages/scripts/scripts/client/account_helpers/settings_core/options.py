# 2017.02.03 21:46:55 Støední Evropa (bìžný èas)
...
class DamageLogEventPositionsSetting(GroupSetting):
    ...
    def getDefaultValue(self):
        return 0
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\account_helpers\settings_core\options.pyc 

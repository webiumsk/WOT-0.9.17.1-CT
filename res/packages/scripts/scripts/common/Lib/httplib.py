...
class LineAndFileWrapper():
    ...
    def readlines(self, size = None):
        if self._line_consumed:
            ...
            return None
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\common\Lib\httplib.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:56:13 Støední Evropa (bìžný èas)

# 2017.02.03 21:54:27 Støední Evropa (bìžný èas)
...
class CompoundAppearance(ComponentSystem, CallbackDelayer):
    ...
    def onSiegeStateChanged(self, newState):
        ...
        return
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\vehicle_systems\CompoundAppearance.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2017.02.03 21:54:28 Støední Evropa (bìžný èas)

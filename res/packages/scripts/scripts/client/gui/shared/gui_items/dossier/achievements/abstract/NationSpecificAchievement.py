...
class NationSpecificAchievement(SimpleProgressAchievement):
    ...
    def __cmp__(self, other):
        ...
        return 0
# okay decompyling c:\Users\PC\wotsources\files\originals\res\packages\scripts\scripts\client\gui\shared\gui_items\dossier\achievements\abstract\NationSpecificAchievement.pyc 
